...
# predicition is an array of 64 arrays, one for each entry in the batch
...
print(len(pred))
print(pred)
# 2d array of length 100, where each interior array is the prediction for the next character at each time step
...
# Determine the predicted character by sampling the output distribution (pick a value based on probabillity)
